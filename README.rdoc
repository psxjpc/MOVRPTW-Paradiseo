...
= MOVRPTW-Paradiseo - Multi-objective Vehicle Routing Problem with Time Windows implementation
using Paradiseo-MOEO.
...
[2] LaTorre, A., Clautiaux, F., Talbi, E., Peña, J.: VRP-extended: When confidence
and fleet size are also important. In: Talbi, E.G. (ed.) Proceedings of the 2nd International 
Conference on Metaheuristics and Nature Inspired Computing, META 2008 (2008)
...
INCLUDEPATH += /opt/paradiseo/paradiseo-1.2.1/paradiseo-moeo/src \
   /opt/paradiseo/paradiseo-1.2.1/paradiseo-moeo/src/utils \
   /opt/paradiseo/paradiseo-1.2.1/paradiseo-eo/src \
...
HEADERS += \
    src/moeoVRP.h \
    src/moeoVRPEvalFunc.h \
    src/moeoVRPUtils.h \
    src/moeoVRPStat.h \
    src/moeoVRPQuadCrossover.h \
    src/moeoVRPMutation.h \
    src/moeoVRPInit.h \
    src/moeoVRPObjectiveVectorTraits.h \
    src/doMakes.h
SOURCES += application/CVRP-TW.cpp
...
In order to run the binary file, you must provide:
 ...
 - seed
Example: ./<binary_file> moeoNSGAII solomonData.dat distanceMatrixData.dat timeMatrixData.dat 20 1000 0
